...
import UnlimSimController from './UnlimSimController'
...
export default class SimController {
  ...
  static async getOrCreate(req: Request, res: Response): Promise<Response> {
    ...
    return res.send(await UnlimSimController.store(appSim, states))
  }
}
